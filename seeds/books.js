      ...
      return Promise.all(
        seedData.map(book => {
          return knex('books').insert({
            id: book.id, title: book.title, author: book.author, genre: book.genre, description: book.description, cover_url: book.cover_url, created_at: book.created_at, updated_at: book.updated_at
          })
        })
      );
    }).then(() => {
